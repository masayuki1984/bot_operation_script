...
upload_path = config['bitflyer']['BTC_JPY']['UPLOAD_PATH']
target_coin = config['bitflyer']['BTC_JPY']['SYMBOL']
...
file_name = "BTC_JPY_ohlcv_{}.pkl".format(yesterday_year + yesterday_month + yesterday_day)
